...
const eyeRecordSchema = new mongoose_1.Schema({
    patient: { type: mongoose_1.Schema.Types.ObjectId, ref: 'User', required: true },
    doctor: { type: mongoose_1.Schema.Types.ObjectId, ref: 'User' },
    visualAcuity: {
...
exports.default = mongoose_1.default.model('EyeRecord', eyeRecordSchema);
