...
import { Loader2, Calendar, Video, Building, ArrowRight, UserSquare2, Clock } from "lucide-react";
                ...
                <CardContent className="p-0">
                  <div className="flex flex-col md:flex-row items-stretch">
                    ...
                    <div className="p-6 flex-1 flex flex-col justify-between">
                      ...
                      {/* Actions */}
                      <div className="flex items-center justify-end pt-4 mt-6 border-t border-border/50">
